...
func Parse(buf string) (model.Rule, error) {
	rule := model.Rule{
		Raw: buf,
	}
	...
	for {
		...
		rule.Options = rule.Options + option + ":" + arg + ","
...
func ParseReader(reader io.Reader) ([]model.Rule, error) {
...
// considered an error.
func (r *RuleReader) Next() (model.Rule, error) {
